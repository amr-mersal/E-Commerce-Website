...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="w-50 m-auto">
            <input type="submit" name="edit_product1" value="update product" class="btn btn-info px-3 mb-3">
        </div>
...
if (isset($_POST['edit_product1'])) {
    ...
    //check condation al makan fadee wla laa
    if ($product_title == '' or $product_desc == '' or $product_keywords == '' or $product_category == '' or $product_brands == '' or $product_image1 == '' or $product_image2 == '' or $product_image3 == '' or $product_price == '') {
        echo "<script>alert('Please fill all fileds and continue') </script>";
    } else {
